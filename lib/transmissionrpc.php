...
class TransmissionRPC
{
  ...
  public function GetSessionID()
  {
    ...
    $stream_meta = stream_get_meta_data($fp);
      ...
      if (substr($stream_meta['wrapper_data'][0], 9, 3) == '401') {
          ...
          // This is what we're hoping to find
   ...
   */
  public function __construct($url = 'http://media.dev.riboflav.in:5004/transmission/rpc', $username = null, $password = null, $return_as_array = false)
  {
      // server URL
    $this->url = $url;
